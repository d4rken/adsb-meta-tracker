package eu.darken.adsbmt.common.github
...
import eu.darken.adsbmt.common.debug.logging.Logging.Priority.INFO
...
class GithubReleaseCheck @Inject constructor(
    ...
    suspend fun latestRelease(owner: String, repo: String): GithubApi.ReleaseInfo = withContext(dispatcherProvider.IO) {
        log(TAG, Logging.Priority.VERBOSE) { "latestRelease(owner=$owner, repo=$repo)" }
